        ...
        <div class="container">
                  ...
                  <form action="cxdb">				
					 <div id="datetimepicker1" class="input-append">
                        <input name="timenow1" data-format="yyyy-MM-dd" type="text" class="form-control dtpicker">
                        <span class="add-on">
                    ...
                    <hr />  
                      ...
                      <div id="datetimepicker2" class="input-append">
                        <input name="timenow2" data-format="hh:mm:ss" class="form-control dtpicker" type="text">
                        <span class="add-on">
                          <i data-time-icon="icon-time" data-date-icon="icon-calendar" class="btn btn-info btn-lg"></i>
                        </span>
                      </div>
                      ...
                      <hr /> 
                        ...
                        <select name="seqnumber" style="width: 62px; height: 28px">
                                                <option>1</option>
                                                <option>2</option>
                                                <option>3</option>
                                                <option>4</option>
                    ...
                    <table class="table table-striped table-bordered table-hover">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>${als.powerwu}</td>
                          <td>${als.powershi}</td>
                          <td>${als.powerfactor}</td>
                           <td>${als.powerangle}</td>
                        </tr>
                          </c:forEach>
                    ...
                    <table class="table table-striped table-bordered table-hover">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>${bs.bpowerwu}</td>
                          <td>${bs.bpowershi}</td>
                          <td>${bs.bpowerfactor}</td>
                           <td>${bs.bpowerangle}</td>
                        </tr>
                          </c:forEach>
                    ...
                    <table class="table table-striped table-bordered table-hover">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>${cs.cpowerwu}</td>
                          <td>${cs.cpowershi}</td>
                          <td>${cs.cpowerfactor}</td>
                           <td>${cs.cpowerangle}</td>
                        </tr>
                          </c:forEach>
