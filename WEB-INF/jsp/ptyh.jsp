...
<div class="content">
    ...
    <!-- Sidebar ends -->
      ...
      <!-- Page heading -->
      <div class="page-head">
        <h2 class="pull-left"><i class="icon-table"></i> 普通用户信息</h2>
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <div class="widget-head">
                  <div class="pull-left">普通用户信息
                  &nbsp;&nbsp;&nbsp;&nbsp;
                  <a href="addptyh.jsp">添加普通用户</a></div>
                    ...
                    <table class="table table-striped table-bordered table-hover">
                      ...
                      <tbody>
                       ...
                       <c:forEach  items="${cs}" var="cs">
                              ...
                              <button class="btn btn-xs btn-warning" onClick="location.href='/ElectricityMeterInfo/updatePtyh?pno=${cs.pno}'">
                              <i class="icon-pencil"></i> </button>
                              <button class="btn btn-xs btn-danger"  onClick="location.href='/ElectricityMeterInfo/deletePtyh?pno=${cs.pno}'">
