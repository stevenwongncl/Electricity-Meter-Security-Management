                        ...
                        <form action="login" method="post">
                           ...
                           <input type="text" id="verifyCode" name="verifyCode" placeholder="验证码" class="l_float" maxlength="4">                                                               
                            ...
                            <div class="b_clear submit">                               
                                ...
                                <a href="${pageContext.request.contextPath }/addptyh">未注册？</a> &nbsp;&nbsp;
                    ...
                    <div class="login_con hidden">
                          <div class="v_ali">
                                 <form action="sentMsg" method="post">                              
                                                                                                                           手机号：
                  <div class="l_lin">                                                                                                        
                 <input type="text" name="smsMob"  id="smsMob" placeholder="手机号" maxlength="11" onkeyup = "value=value.replace(/[^\d]/g,'')"/>
                 </div> 
                 <div class="l_lin">
